# Beyond ordinary least squares: when linear-model assumptions fail
...
> transforms](https://bastienchassagnol.github.io/DeCovarT/articles/generative-model-derivatives.html#sec-s3).
