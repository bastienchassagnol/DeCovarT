...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item $\boldsymbol{\Sigma}_{j}$, the covariance matrix of each cell
            ...
            the precision matrix, through the gLasso \cite{mazumderGraphicalLassoNew2011} algorithm.
            We define
    ...
    \begin{appendices}
        ...
        \cite{shafarevichLinearEquations2013}. Briefly, uniqueness of the solution
        ...
        to be \emph{overdetermined} \cite{abbasDeconvolutionBloodMicroarray2009}.
        ...
        \begin{proof}[Proof of Gauss-Markov theorem]
            ...
            {y}_{j}, \boldsymbol{y}_{k})=0$, even though \cite{efronAreSetMicroarrays2009} tends to
