...
\begin{document}
    ...
    \begin{appendices}
        ...
        $\mathbb{E}_{\boldsymbol{p}_{0}}\{\ell(\boldsymbol{p})\}$ under the
        rank condition of \ref{subsec:model-assumptions-rank}, and the local
        curvature of that divergence is exactly \ref{eq-expected-fisher}
        ...
        apply and the additive log-ratio chart cannot even represent the null
        ($\rho_{j}=-\infty$). Following
