...
Software (knitr::write_bib — not Zotero):
  ...
  Regenerated by scripts/curate_bibliography/generate_packages_bib.R; not field-stripped.
...
Usage:
  python3 scripts/curate_bibliography/check_bibliography.py
  python3 scripts/curate_bibliography/check_bibliography.py --clean
  python3 scripts/curate_bibliography/check_bibliography.py --check-qmd

Enrichment companion (home user environment, no repo-local .venv):
  python3 scripts/curate_bibliography/bib_enrich.py inst/REFERENCES.bib \\
...
% Enrich incomplete entries (default home environment): python3 scripts/curate_bibliography/bib_enrich.py
% Clean / check with: python3 scripts/curate_bibliography/check_bibliography.py [--clean]
"""
    ...
    if INST_PKG_BIB.is_file() and ARTICLE_PKG_BIB.is_file():
        ...
        if pa != pb:
            errors.append(
                ...
                "run: Rscript scripts/curate_bibliography/generate_packages_bib.R"
            )
