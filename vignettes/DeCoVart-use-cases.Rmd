...
(ref:erkkila) Graphical representation of the DSection generative model [@erkkila_etal10]

(ref:ahn) Graphical representation of the DemixT generative model [@ahn_etal13; @wang_etal18]

(ref:chion) Graphical representation of [@chion18] generative model
...
### Additional details on extended DeCovarT Bayesian framework
...
Generally, the idea of the Gibbs sampling is to decompose the set of parameters to sample into independent blocks, and update each of them in the same iteration, conditioned on the most updated version of the remaining parameter subsets. Retrieve more details on [Gibbs sampling](https://www.statlect.com/fundamentals-of-statistics/Markov-Chain-Monte-Carlo).
::::
