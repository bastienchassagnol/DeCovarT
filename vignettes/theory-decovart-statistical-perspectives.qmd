...
## Ordinary least squares and Gauss--Markov {#sec-ols}
...
the MLE for $\boldsymbol{p}_{\cdot i}$ coincides with @eq-ols-estimate.

### Gauss--Markov assumptions {#sec-gauss-markov}
...
[derivatives under simplex transforms](theory-decovart-generative-model.html#sec-s3).
:::
